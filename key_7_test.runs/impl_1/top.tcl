...
set rc [catch {
  ...
  set_property ip_repo_paths d:/vivado/key_7_test/key_7_test.cache/ip [current_project]
  set_property ip_output_repo d:/vivado/key_7_test/key_7_test.cache/ip [current_project]
  add_files -quiet D:/vivado/key_7_test/key_7_test.runs/synth_1/top.dcp
